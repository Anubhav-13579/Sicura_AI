...
exports.ConfigurationException = exports.PolicyHoldException = exports.PolicyBlockedException = exports.RevokedTokenError = exports.DelegationException = exports.MCPInvocationException = exports.TokenExpiredException = exports.IntentMismatchException = exports.InvalidTokenException = exports.ArmorIQException = void 0;
/**
 ...
 */
class RevokedTokenError extends ArmorIQException {
    tokenId;
    reason;
    constructor(message, tokenId, reason) {
        super(message);
...
class PolicyBlockedException extends ArmorIQException {
    ...
    metadata;
    matchedPolicy;
    constructor(message, enforcementAction, reason, metadata, matchedPolicy) {
        super(message);
...
class PolicyHoldException extends ArmorIQException {
    ...
    metadata;
    matchedPolicy;
    constructor(message, delegationContext, metadata, matchedPolicy) {
        super(message);
